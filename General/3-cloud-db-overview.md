...
- Single database
    - We can pay based on 
        ...
        -  vcore model with 
            - [a provisionned](https://docs.microsoft.com/en-us/azure/azure-sql/database/service-tiers-sql-database-vcore): Main differnce with DTU is that we can customize config and not take a pre-exisiting package of RAM, CPU and storage ([PaaS with node farm but no @ccess]((1-cloud_iass-pass-saas.md#From-IaaS-to-diffferent-level-of-PaaS).))
            - [serverless tier](https://docs.microsoft.com/en-us/azure/azure-sql/database/serverless-tier-overview) ([Serverless]((1-cloud_iass-pass-saas.md#From-IaaS-to-diffferent-level-of-PaaS).))
